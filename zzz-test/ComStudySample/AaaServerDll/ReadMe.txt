========================================================================
    ACTIVE TEMPLATE LIBRARY : AaaServerDll Project Overview
========================================================================

AppWizard has created this AaaServerDll project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

AaaServerDll.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

AaaServerDll.vcxproj.filters
...
AaaServerDll.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AaaServerDll.h)
        GUID definitions                                (AaaServerDll_i.c)
        A type library                                  (AaaServerDll.tlb)
        Marshaling code                                 (AaaServerDll_p.c and dlldata.c)

AaaServerDll.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AaaServerDll.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AaaServerDll.pch and a precompiled types file named StdAfx.obj.
...
AaaServerDllps.vcxproj
	...
	dlldata.c, AaaServerDll_i.c and AaaServerDll_p.c which are required
	to build the proxy/stub DLL.

AaaServerDllps.vcxproj.filters
