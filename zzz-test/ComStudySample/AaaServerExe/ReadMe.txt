========================================================================
    ACTIVE TEMPLATE LIBRARY : AaaServerExe Project Overview
========================================================================

AppWizard has created this AaaServerExe project for you to use as the starting point for
writing your Service (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

AaaServerExe.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

AaaServerExe.vcxproj.filters
...
AaaServerExe.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AaaServerExe.h)
        GUID definitions                                (AaaServerExe_i.c)
        A type library                                  (AaaServerExe.tlb)
        Marshaling code                                 (AaaServerExe_p.c and dlldata.c)

AaaServerExe.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AaaServerExe.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AaaServerExe.pch and a precompiled types file named StdAfx.obj.
...
AaaServerExeps.vcxproj
	...
	dlldata.c, AaaServerExe_i.c and AaaServerExe_p.c which are required
	to build the proxy/stub DLL.

AaaServerExeps.vcxproj.filters
