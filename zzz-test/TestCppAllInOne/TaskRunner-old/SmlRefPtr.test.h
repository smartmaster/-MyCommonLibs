...
namespace SmartLib
{
	...
	public:
		...
		static void Case2()
		{
			RefObjectBlock<MyRCObj> ob1{"111"};
			RefObjectBlock<MyRCObj> ob2{"222"};
			RefObjectBlock<MyRCObj> ob3{ "333" };
		...
		static void Case1()
		{
			...
			}
			{
				...
				RefObjectBlock<WCHAR*> obj{ (WCHAR*)malloc(100 * sizeof(WCHAR)) };
				obj.SetDispose(dispose);
				_tcscpy_s(obj.Object(), BUFFER_SIZE, TEXT("hello world"));
		...
		static void Case0()
		{
...

			{
				...
				strcpy_s(sp1.Object(), BUFFER_SIZE, "hello world");
