...
namespace SmartLib
{
	...
	public:
		...
		static void Case11()
		{
			...
			{
				lst.InsertBefore(lst.First(), to_string(ii));
			}
			Print(lst);
		...
		static void Case10()
		{
			...
			//////////////////////////////////////////////////////////////////////////
			{
				...
				List<string> lst;
				lst.AppendData(vec.begin(), vec.end());
				Print(lst);
				cout << endl;
			}
			...
			//////////////////////////////////////////////////////////////////////////
			{
				...
				List<string> lst;
				lst.AppendDataMove(&vec[0], vec.size());
				Print(lst);
				cout << endl;
			}
			...
			//////////////////////////////////////////////////////////////////////////
			{
				...
				List<string> lst;
				lst.AppendDataMove(vec.begin(), vec.end());
				Print(lst);
				cout << endl;
			}
		}
