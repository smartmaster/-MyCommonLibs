...
// MessageText:
//
// 此服務有助於 ^AU_ProductName_HBVB^ 收集已變更的區塊追蹤資料。
//
...
// MessageText:
//
// 此服務可使用 ^AU_ProductName_HBVB^ 收集應用程式中繼資料。
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^ VM 整合服務安裝程式
//
...
// MessageText:
//
// 將 ^AU_ProductName_HBVB^ VM 整合服務安裝到本機機器
//
...
// MessageText:
//
// 從本機機器解除安裝 ^AU_ProductName_HBVB^ VM 整合服務
//
...
// MessageText:
//
// 已成功安裝 ^AU_ProductName_HBVB^ VM 整合服務
//
...
// MessageText:
//
// 無法安裝 ^AU_ProductName_HBVB^ VM 整合服務
//
...
// MessageText:
//
// 已成功解除安裝 ^AU_ProductName_HBVB^ VM 整合服務
//
...
// MessageText:
//
// 無法解除安裝 ^AU_ProductName_HBVB^ VM 整合服務
//
