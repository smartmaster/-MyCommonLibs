...
// MessageText:
//
// ^AU_ProductName_AGENT^-CBT-Dienst
//
...
// MessageText:
//
// Dieser Dienst hilft ^AU_ProductName_HBVB^ dabei, ge?nderte Verfolgungsdaten des Blocks zu erfassen.
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^ VM-Integrationsdienst
//
...
// MessageText:
//
// Dieser Dienst hilft ^AU_ProductName_HBVB^ dabei, Anwendungsmetadaten zu erfassen.
//
...
// MessageText:
//
// Installationsprogramm f¨¹r ^AU_ProductName_HBVB^ VM-Integrationsdienst
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst auf lokalem Rechner installieren
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst vom lokalen Rechner deinstallieren
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst erfolgreich installiert
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst konnte nicht installiert werden.
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst erfolgreich deinstalliert
//
...
// MessageText:
//
// ^AU_ProductName_HBVB^-VM-Integrationsdienst konnte nicht deinstalliert werden.
//
