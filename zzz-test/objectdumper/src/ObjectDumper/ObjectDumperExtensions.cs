...
namespace ObjectDumper
{
    ...
    public static class ObjectDumperExtensions
    {
        ...
        /// </exception>
        public static T Dump<T>(this T value, string name, bool dumpFields)
        {
            ...
            {
                return Dump(value, name, writer, dumpFields);
            }
        }
        ...
        /// </exception>
        public static T Dump<T>(this T value, string name, string filename, bool dumpFields)
        {
            // Error-checking in called method

            return Dump(value, filename, name, Encoding.Default, dumpFields);
        }
        ...
        /// </exception>
        public static T Dump<T>(this T value, string name, string filename, Encoding encoding, bool dumpFields)
        {
            if (StringEx.IsNullOrWhiteSpace(name))
                throw new ArgumentNullException("name");
        ...
        /// </exception>
        public static T Dump<T>(this T value, string name, TextWriter writer, bool dumpFields)
        {
            if (StringEx.IsNullOrWhiteSpace(name))
                throw new ArgumentNullException("name");
            if (writer == null)
            ...
            Dumper.Dump(value, name, writer, dumpFields);
        ...
        /// <para><paramref name="name"/> is <c>null</c> or empty.</para>
        /// </exception>
        public static string DumpToString<T>(this T value, string name, bool dumpFields)
        {
            // Error-checking in called method

            using (var writer = new StringWriter(CultureInfo.InvariantCulture))
            {
                Dump(value, name, writer, dumpFields);
