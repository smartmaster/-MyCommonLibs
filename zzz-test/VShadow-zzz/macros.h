...
#ifdef _DEBUG
    #define _VSHADOW_ASSERTE(x) {                               \
        if (!(x))                                       \
        {                                           \
            D_INFO(0, L"ASSERTION FAILED: %S", #x);       \
            D_INFO(0, L"- File: %s- Line: %d- Function: %s  --*r*n*--  ", DBG_INFO); \
            D_INFO(0, L"  --*r*n*--  Press <ENTER> to continue...");     \
            int gc = getchar();                              \
        }                                           \
    }
#else
...
{                                                                                           \
    ...
    {                                                                                       \
        ft.WriteLine(L"  --*r*n*--  ERROR: COM call %s failed.", GEN_WSTRINGIZE(Text));                \
...
{                                                                                           \
    ...
    {                                                                                       \
        ft.WriteLine(L"  --*r*n*--  ERROR: Win32 call %s failed.", GEN_WSTRINGIZE(Text));          \
