========================================================================
    ACTIVE TEMPLATE LIBRARY : Free Project Overview
========================================================================

AppWizard has created this Free project for you to use as the starting point for
...
Free.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Free.h)
        GUID definitions                                (Free_i.c)
        A type library                                  (Free.tlb)
        Marshaling code                                 (Free_p.c and dlldata.c)

Free.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Free.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Free.pch and a precompiled types file named StdAfx.obj.
...
Freeps.vcxproj
	...
	dlldata.c, Free_i.c and Free_p.c which are required
	to build the proxy/stub DLL.

Freeps.vcxproj.filters
