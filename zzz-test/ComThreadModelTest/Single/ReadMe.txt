========================================================================
    ACTIVE TEMPLATE LIBRARY : Single Project Overview
========================================================================

AppWizard has created this Single project for you to use as the starting point for
...
Single.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Single.h)
        GUID definitions                                (Single_i.c)
        A type library                                  (Single.tlb)
        Marshaling code                                 (Single_p.c and dlldata.c)

Single.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Single.idl. It will be regenerated by MIDL during compilation.
...
Singleps.vcxproj
	...
	dlldata.c, Single_i.c and Single_p.c which are required
	to build the proxy/stub DLL.

Singleps.vcxproj.filters
