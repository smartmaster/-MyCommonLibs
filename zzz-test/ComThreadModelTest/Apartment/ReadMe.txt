========================================================================
    ACTIVE TEMPLATE LIBRARY : Apartment Project Overview
========================================================================

AppWizard has created this Apartment project for you to use as the starting point for
...
Apartment.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Apartment.h)
        GUID definitions                                (Apartment_i.c)
        A type library                                  (Apartment.tlb)
        Marshaling code                                 (Apartment_p.c and dlldata.c)

Apartment.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Apartment.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Apartment.pch and a precompiled types file named StdAfx.obj.
...
Apartmentps.vcxproj
	...
	dlldata.c, Apartment_i.c and Apartment_p.c which are required
	to build the proxy/stub DLL.

Apartmentps.vcxproj.filters
