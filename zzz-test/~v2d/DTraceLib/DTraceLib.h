...
//////////////////////////////////////////////////////////////////////////
__DECLSPEC_DLLAPI VOID WINAPI DTraceSetDebugSettings(INT nDebugLevel, BOOL bInXml, LPCTSTR strPrefix, LPCTSTR strLogFolder);

__DECLSPEC_DLLAPI VOID WINAPIV DTraceInfo(
	INT nDebugLevel, LPCTSTR szEnding, 
	LPCTSTR szFunction, LPCTSTR szFile, INT line, 
	LPCTSTR szFormat = TEXT(""), ...
	);

__DECLSPEC_DLLAPI VOID WINAPIV DTraceAPIErr(
	INT nDebugLevel, LPCTSTR szEnding, 
	LPCTSTR szFunction, LPCTSTR szFile, INT line, 
...
#define DSETTINGS(nDebugLevel, bInXml, strPrefix, strLogFolder)		DTraceSetDebugSettings(nDebugLevel, bInXml, strPrefix, strLogFolder)
...
{
	DSETTINGS(LEVEL_TRACE_VERBOSE_MAX, (NULL != bInXml), TEXT("F:\\temp"));
