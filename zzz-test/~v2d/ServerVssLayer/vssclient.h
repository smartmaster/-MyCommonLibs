...
public:
	...
	//******************************************
	VOID InitializeStorage(IStorage * pIStorageXmls, IStorage * pIStorageVssResults, DWORD * pdwCookieIVssBackupComponents); //<mc> 2010-8-21 19:10);
	...
	IVssBackupComponents * RawVssObjectPtr() //<mc> 2010-8-21 19:13
	{
		return (IVssBackupComponents*)m_pVssObject;
	}
...
private:
	...
	//******************************************
	IStorage * m_pIStorageXmls; //outside object
	IStorage *m_pIStorageVssResults; //outside object
	DWORD * m_pdwCookieIVssBackupComponents;
};
