...
INT CSingleDiskInfo::Retrieve( DWORD dwDiskNumber, BOOL bBreakOnError )
{
	...
	do 
	{
		...
		{
			nStatus = E_FAIL;
			_OLD_DAPIERR((0, DRNPOS, TEXT("CreateHandle"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_DISK_GET_DRIVE_GEOMETRY_EX_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_DISK_GET_DRIVE_LAYOUT_EX_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_DISK_GET_PARTITION_INFO_EX_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_DISK_GET_LENGTH_INFO_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_QUERY_PROPERTY_DEVICE_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_QUERY_PROPERTY_ADAPTER_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		if (nStatus)
		{
			...
			_OLD_DAPIERR((999, DRNPOS, TEXT("IOCTL_STORAGE_QUERY_PROPERTY_ID_Helper"), nStatus, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			//break;
		}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_QUERY_PROPERTY_UNIQUE_ID_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_GET_DEVICE_NUMBER_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_GET_HOTPLUG_INFO_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
		...
		{
			//nStatus = -1;
			_OLD_DAPIERR((0, DRNPOS, TEXT("IOCTL_STORAGE_GET_MEDIA_TYPES_EX_Helper"), E_FAIL, TEXT("m_DiskNumber=[%u]"), m_DiskNumber));
			if (bBreakOnError)
			{
				break;
			}
...
INT CSingleDiskInfo::WriteToStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleDiskInfo); ++ii)
	{
		...
		if (FAILED(hr))
		{
			...
			_OLD_DAPIERR((0, DRNPOS, TEXT("CreateStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
			nStatus = hr;
			break;
		}
		...
		if (0 == ii)
		{
			...
			{
				_OLD_DSETLASTSTATUS(hr);
				_OLD_DAPIERR((0, DRNPOS, TEXT("WriteToStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
				nStatus = hr;
				break;
			}
		}
		else if (1 == ii)
		{
			...
			if (m_pDiskGeometryEx)
			{
				...
				{
					_OLD_DSETLASTSTATUS(hr);
					_OLD_DAPIERR((0, DRNPOS, TEXT("spIStream->Write"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
					nStatus = hr;
					break;
				}
			}
...
INT CSingleDiskInfo::ReadFromStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleDiskInfo); ++ii)
	{
		...
		{
			_OLD_DSETLASTSTATUS(hr);
			_OLD_DAPIERR((0, DRNPOS, TEXT("OpenStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
			nStatus = hr;
			break;
		}
		...
		if (0 == ii)
		{
			...
			if (VT_UI4 != var.vt)
			{
				...
				_OLD_DAPIERR((0, DRNPOS, TEXT("VT_UI4 != var.vt"), E_INVALIDARG, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
		...
		else if (1 == ii)
		{
			...
			{
				_OLD_DSETLASTSTATUS(hr);
				_OLD_DAPIERR((0, DRNPOS, TEXT("spIStream->Stat"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
				nStatus = hr;
				break;
			}
			...
			if (!bRet)
			{
				...
				_OLD_DAPIERR((0, DRNPOS, TEXT("Allocate"), E_OUTOFMEMORY, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
			...
			{
				_OLD_DSETLASTSTATUS(hr);
				_OLD_DAPIERR((0, DRNPOS, TEXT("spIStream->Read"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleDiskInfo[ii]));
				nStatus = hr;
				break;
			}
...
INT CAllDiskInfo::Retrieve( DWORD dwMaxDiskNumber )
{
	...
	for (size_t ii=0; ii<DiskNumbers.size(); ++ii)
	{
		...
		if (nStatus)
		{
			_OLD_DAPIERR((0, DRNPOS, TEXT("Retrieve"), E_FAIL, TEXT("[dwDiskNumber=%u]"), dwDiskNumber));
		}
		else 
		{
