...
//******************************************************************************
class /*DEBUG_LOG_DLLAPI*/ CDTraceLogger 
{
private:
	BOOL m_bSetSettings;
	INT m_nDebugLevel;
...
public:
	...
	//******************************************************************************
	VOID SetDebugSettings(INT nDebugLevel, BOOL bInXml);
	INT GetDebugLevel();
	BOOL IsInXml();
...
static CDTraceLogger g_DTraceLogger;

//////////////////////////////////////////////////////////////////////////
VOID CDTraceLogger::CreateMember()
{
	m_bSetSettings = FALSE;
	m_nDebugLevel = 0;
	m_bInXml = TRUE;
...
//******************************************************************************
VOID CDTraceLogger::SetDebugSettings( INT nDebugLevel, BOOL bInXml )
{
	if (!m_bSetSettings)
	{
...
VOID CDTraceLogger::GenerateNewLogFile( BOOL bFirstTime )
{
	...
	m_strFileName.AppendFormat(
		TEXT(".%04d") TEXT(".%04d%02d%02d-%02d%02d%02d-%03d.log.xml"),//LPCTSTR pszFormat,
		GetCurrentProcessId(), SystemTime.wYear, SystemTime.wMonth, SystemTime.wDay, 
...
m_nDebuglevel(nDebuglevel)
{
	...
	{
		//********************************************
		if (m_nDebuglevel > g_DTraceLogger.GetDebugLevel())
		{
			break;
		}
...
//******************************************************************************
VOID WINAPI DTraceSetDebugSettings( INT nDebugLevel, BOOL bInXml )
{
	g_DTraceLogger.SetDebugSettings(nDebugLevel, bInXml);
}

//******************************************************************************
VOID WINAPIV DTraceInfo(
						...
						)
{
	...
	{
		//******************************************************************************
		if (nDebugLevel > g_DTraceLogger.GetDebugLevel())
		{
			break;
		}
