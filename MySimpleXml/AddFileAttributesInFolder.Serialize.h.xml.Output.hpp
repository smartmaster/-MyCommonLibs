...
VOID AddFileAttributesInFolderSerialize::ToElement(LPCTSTR RootName, XmlElement & xmlElement) CONST
{
	xmlElement.m_Name = RootName;

	AllocateOneMore(xmlElement.m_Children);
	/*VectorToElement*/ContainerToElement(FIELD_NAME(FileExtensions), FileExtensions, Last(xmlElement.m_Children));
...
////////////////////////////RRRRRR BEGIN//////////////////////////////////////////////
VOID AddFileAttributesInFolderSerialize::FromElement(LPCTSTR RootName, CONST XmlElement & xmlElement)
{
	...
	for (size_t ik9856i = 0; ik9856i < xmlElement.m_Children.size(); ++ ik9856i )
	{
		...
		else if (0 == Child_jfs654.m_Name.CompareNoCase(FIELD_NAME(FileExtensions)))
		{
			/*ElementToVector*/ElementToContainer(FIELD_NAME(FileExtensions), FileExtensions, Child_jfs654);
		}
	}
}
VOID AddFileAttributesInFolderSerialize::ToString( LPCTSTR RootName, CString & strXml ) CONST
{
...
HRESULT AddFileAttributesInFolderSerialize::FromString( LPCTSTR RootName, CONST CString & strXml )
{
	XmlElement xmlElement;
	INT Start = 0;
	HRESULT hr = S_OK;
...
HRESULT AddFileAttributesInFolderSerialize::ToStream( LPCTSTR RootName, IFileDevice * pIFileDevice ) CONST
{
	HRESULT hr = S_OK;
	BEGIN_BLOCK(0);
	CString strXml;
...
HRESULT AddFileAttributesInFolderSerialize::FromStream( LPCTSTR RootName, IFileDevice * pIFileDevice )
{
	HRESULT hr = S_OK;
	DWORD LastError = 0;
	BEGIN_BLOCK(0);
...
HRESULT AddFileAttributesInFolderSerialize::ToFile( LPCTSTR RootName, LPCTSTR pFileName ) CONST
{
	HRESULT hr = S_OK;
	DWORD LastError = 0;
	BEGIN_BLOCK(0);
...
HRESULT AddFileAttributesInFolderSerialize::FromFile( LPCTSTR RootName, LPCTSTR pFileName )
{
	HRESULT hr = S_OK;
	DWORD LastError = 0;
	BEGIN_BLOCK(0);
