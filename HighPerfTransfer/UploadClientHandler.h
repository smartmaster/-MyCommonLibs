...
class CUploadClientHandler : public IHPTHandler
{
private:
...
private:
	HRESULT ProcessCommand_CMD_CREATE_UPLOAD_SESSION_RSP(CONST HPTHeader & Header, CONST HPTBody & Body, CCircularBuffer * pCircBufferResult, CCircularBuffer * pCircBufferRecieve);
	HRESULT ProcessCommand_CMD_END_UPLOAD_RSP(CONST HPTHeader & Header, CONST HPTBody & Body, CCircularBuffer * pCircBufferResult, CCircularBuffer * pCircBufferRecieve);
...
public:
	CUploadClientHandler();

	IMP_CLASS_DESTRUCTOR(CUploadClientHandler);
	...
	IMP_WHO_AM_I(TEXT("CUploadClientHandler:IHPTHandler"));
