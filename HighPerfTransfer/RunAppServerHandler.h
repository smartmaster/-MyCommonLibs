...
#include "..\PublicHeader\PublicInterfaceRunApp.h"
...
class CRunAppServerHandler : public IHPTHandler
{
private:
...
private:
	...
	HRESULT ProcessCommand_CMD_RUN_APP_REQ(CONST HPTHeader & Header, CONST HPTBody & Body, CCircularBuffer * pCircBufferResult, CCircularBuffer * pCircBufferRecieve);
...
public:
	...
	CRunAppServerHandler(CONST HPTHeader & Header, CONST HPTBody & Body);

	IMP_CLASS_DESTRUCTOR(CRunAppServerHandler);
	...
	IMP_WHO_AM_I(TEXT("CRunAppServerHandler:IHPTHandler"));
