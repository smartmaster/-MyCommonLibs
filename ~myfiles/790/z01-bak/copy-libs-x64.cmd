...
xcopy "%__source_root%\OpensslHelper\x64\*.lib" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\HighPerfTransfer\x64\*.lib" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
xcopy "%__source_root%\SharedSocketProcess\x64\*.lib" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\OpensslHelper\x64\*.pdb" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\HighPerfTransfer\x64\*.pdb" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
xcopy "%__source_root%\SharedSocketProcess\x64\*.pdb" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\OpensslHelper\x64\*.dll" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\HighPerfTransfer\x64\*.dll" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
xcopy "%__source_root%\SharedSocketProcess\x64\*.dll" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\OpensslHelper\x64\*.exe" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
...
xcopy "%__source_root%\HighPerfTransfer\x64\*.exe" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
xcopy "%__source_root%\SharedSocketProcess\x64\*.exe" "%__dest_x64%\" /s /e /h /i /c /y /exclude:excluded.txt
