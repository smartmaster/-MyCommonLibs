...
INT CSingleVdsDiskInfo::WriteToStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsDiskInfo); ++ii)
	{
		...
		if (FAILED(hr))
		{
			...
			D_API_ERR(0, /*DRNPOS,*/ TEXT("CreateStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
			nStatus = hr;
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("WriteToStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
				break;
			}
		}
		else if (1 == ii) //******************************************
...
INT CSingleVdsDiskInfo::ReadFromStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsDiskInfo); ++ii)
	{
		...
		{
			D_SET_LAST_STATUS(hr, -1);
			D_API_ERR(0, /*DRNPOS,*/ TEXT("OpenStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
			nStatus = hr;
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("ReadFromStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
				break;
			}
		}
		else if (1 == ii) //******************************************
		...
		else if (13 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("Read"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
				break;
			}
		}
		else if (14 == ii) //******************************************
		...
		else if (19 == ii) //******************************************
		{
			...
			{
				D_SET_LAST_STATUS(hr, -1);
				D_API_ERR(0, /*DRNPOS,*/ TEXT("spIStream->Stat"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsDiskInfo[ii]); /*0001*/
				nStatus = hr;
				break;
			}
