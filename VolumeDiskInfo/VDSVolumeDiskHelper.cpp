...
INT CVDSService::Load()
{
	...
	do 
	{
		...
		{	
			...
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("CoCreateInstance"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("LoadService"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("WaitForServiceReady"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("GetProperties"), hr, TEXT("")); /*0004*/
			break;
		}
...
INT CVDSService::QuerySoftwareProvides( vector<IVdsSwProvider*> & swProvides )
{
	...
	do 
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryProviders"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		for (;;)
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("Next"), hr, TEXT("")); /*0004*/
				break;
			}
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsSwProvider)"), hr, TEXT("")); /*0004*/
					break;
				}
		...
		for (;;)
		{
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsHwProvider)"), hr, TEXT("")); /*0004*/
					break;
				}
		...
		for (;;)
		{
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsVdProvider)"), hr, TEXT("")); /*0004*/
					break;
				}
...
INT CVdsSwProvider::QueryPacks( vector<IVdsPack*> & Packs )
{
	...
	do 
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryPacks"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		for (;;)
		{
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsPack)"), hr, TEXT("")); /*0004*/
					break;
				}
...
INT CVdsPack::QueryDisks( vector<IVdsDisk*> & Disks )
{
	...
	do 
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryDisks"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		for (;;)
		{
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsDisk)"), hr, TEXT("")); /*0004*/
					break;
				}
...
INT CVdsPack::QueryVolumes( vector<IVdsVolume*> & Volumes )
{
	...
	do 
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryVolumes"), hr, TEXT("")); /*0004*/
			break;
		}
...
INT CVdsDisk::Initialize( IVdsDisk * pIVdsDisk, BOOL bCopy )
{
	...
	{	
		D_SET_LAST_STATUS(hr, -1);
		nStatus = hr;
		D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryExtents"), hr, TEXT("")); /*0004*/
		//break;
	}
...
INT CVdsVolume::QueryPlexes( vector<IVdsVolumePlex*> & vdsPlexes )
{
	...
	do 
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryPlexes"), hr, TEXT("")); /*0004*/
			break;
		}
		...
		for (;;)
		{
			...
			else
			{
				...
				{	
					D_SET_LAST_STATUS(hr, -1);
					nStatus = hr;
					D_API_ERR(0, /*DRNPOS,*/ TEXT("QueryInterface(&spIVdsVolumePlex)"), hr, TEXT("")); /*0004*/
					break;
				}
