...
INT CSingleVdsVolumePlex::WriteToStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsVolumePlex); ++ii)
	{
		...
		if (FAILED(hr))
		{
			...
			D_API_ERR(0, /*DRNPOS,*/ TEXT("CreateStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumePlex[ii]); /*0001*/
			nStatus = hr;
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("WriteToStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumePlex[ii]); /*0001*/
				break;
			}
		}
		else if (1 == ii) //******************************************
...
INT CSingleVdsVolumePlex::ReadFromStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsVolumePlex); ++ii)
	{
		...
		{
			D_SET_LAST_STATUS(hr, -1);
			D_API_ERR(0, /*DRNPOS,*/ TEXT("OpenStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumePlex[ii]); /*0001*/
			nStatus = hr;
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("Read"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumePlex[ii]); /*0001*/
				break;
			}
		}
		else if (1 == ii) //******************************************
		...
		else if (8 == ii) //******************************************
		{
			...
			{
				D_SET_LAST_STATUS(hr, -1);
				D_API_ERR(0, /*DRNPOS,*/ TEXT("spIStream->Stat"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumePlex[ii]); /*0001*/
				nStatus = hr;
				break;
			}
...
INT CSingleVdsVolumeInfo::WriteToStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsVolumeInfo); ++ii)
	{
		...
		{
			D_SET_LAST_STATUS(hr, -1);
			D_API_ERR(0, /*DRNPOS,*/ TEXT("CreateStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumeInfo[ii]); /*0001*/
			nStatus = hr;
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			{	
				D_SET_LAST_STATUS(hr, -1);
				nStatus = hr;
				D_API_ERR(0, /*DRNPOS,*/ TEXT("WriteToStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumeInfo[ii]); /*0001*/
				break;
			}
		}
		else if (1 == ii) //******************************************
	...
	for (INT ii=0; ii<_countof(szStorageNamesOfCSingleVdsVolumeInfo); ++ii)
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("CreateStorage"), hr, TEXT("[%s]"), szStorageNamesOfCSingleVdsVolumeInfo[ii]); /*0001*/
			break;
		}
		...
		if (0 == ii) //******************************************
		{
			...
			if (nStatus)
			{
				D_API_ERR(0, /*DRNPOS,*/ TEXT("WriteVolumePlexesHelper"), E_FAIL, TEXT("")); /*0009*/
				break;
			}
		}
		//else if (1 == ii) //...
...
INT CSingleVdsVolumeInfo::ReadFromStorage( IStorage * pIStorage )
{
	...
	for (INT ii=0; ii<_countof(szStreamNamesOfCSingleVdsVolumeInfo); ++ii)
	{
		...
		{
			D_SET_LAST_STATUS(hr, -1);
			D_API_ERR(0, /*DRNPOS,*/ TEXT("OpenStream"), hr, TEXT("[StreamNames[%d]]=[%s]"), ii, szStreamNamesOfCSingleVdsVolumeInfo[ii]); /*0001*/
			nStatus = hr;
			break;
		}
	...
	for (INT ii=0; ii<_countof(szStorageNamesOfCSingleVdsVolumeInfo); ++ii)
	{
		...
		{	
			D_SET_LAST_STATUS(hr, -1);
			nStatus = hr;
			D_API_ERR(0, /*DRNPOS,*/ TEXT("OpenStorage"), hr, TEXT("[%s]"), szStorageNamesOfCSingleVdsVolumeInfo[ii]); /*0001*/
			break;
		}
