...
//
    ...
    #define _VSHADOW_ASSERTE(x) {                               \
        ...
        {                                           \
            ...
            D_INFO(0, L"- File: %s- Line: %d- Function: %s", DBG_INFO); \
            D_INFO(0, L"Press <ENTER> to continue...");     \
            DebugBreak();                              \
        }                                           \
    }
#else
...
{                                                                                           \
    ...
    {                                                                                       \
        ft.WriteLine(L"ERROR: COM call %s failed.", GEN_WSTRINGIZE(Text));                \
...
{                                                                                           \
    ...
    {                                                                                       \
        ft.WriteLine(L"ERROR: Win32 call %s failed.", GEN_WSTRINGIZE(Text));          \
