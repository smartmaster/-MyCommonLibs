...
public:
	...
	void DoSnapshotSet(wstring bcdFileName); //<sonmi01>2014-11-21 ###???

    // Ending the backup (calling BackupComplete)
	void BackupComplete(bool succeeded, wstring bcdFileName /*= L""*/); //<sonmi01>2014-11-21 ###???
	...
	void QuerySnapshotSet(VSS_ID snapshotSetID, wstring bcdFileName /*= L""*/);

	//<sonmi01>2016-10-11 ###???
	void QueryProviders(OUT vector<MyProviderInfo>& vecPI);
    ...
    void CheckSelectedWriterStatus(wstring bcdFileName /*= L""*/); //<sonmi01>2014-11-21 ###???
...
private:
	...
	//bcd xml file
	//wstring m_bcdFile; //<sonmi01>2015-6-2 ###???
};
