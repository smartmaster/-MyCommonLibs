...
class CPluginFileFactoryRawIFileDevice : public IPluginFileFactory
{
private:
	LONG m_refCount;

public:
	CPluginFileFactoryRawIFileDevice() :
		m_refCount(0)
	{

	}

	IMP_CLASS_DESTRUCTOR(CPluginFileFactoryRawIFileDevice);
...
public:
	...
	IMP_WHO_AM_I(TEXT("class CPluginFileFactoryRawIFileDevice : public IPluginFileFactory"));
