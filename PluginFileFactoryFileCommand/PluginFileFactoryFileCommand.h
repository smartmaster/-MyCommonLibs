...
class CPluginFileFactoryFileCommandDiskVolumeInfo : public IPluginFileFactory
{
private:
	LONG m_refCount;

public:
	CPluginFileFactoryFileCommandDiskVolumeInfo() :
		m_refCount(0)
	{

	}

	IMP_CLASS_DESTRUCTOR(CPluginFileFactoryFileCommandDiskVolumeInfo);
...
public:
	...
	IMP_WHO_AM_I(TEXT("class CPluginFileFactoryFileTest : public IPluginFileFactory"));
