...
#if 0
#define BEGIN_BLOCK(level_number)			do{	int	sml_1qaz_2wsx_3edc_4rfv_ ## level_number = (level_number) + (__LINE__) - (level_number);
#define LEAVE_BLOCK(level_number)			{(sml_1qaz_2wsx_3edc_4rfv_ ## level_number);}	break;
#define END_BLOCK(level_number)				{(sml_1qaz_2wsx_3edc_4rfv_ ## level_number);}	}while(0);
#endif